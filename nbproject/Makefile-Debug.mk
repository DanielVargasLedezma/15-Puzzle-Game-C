...
${OBJECTDIR}/C_Files/Lista_Registros.o: C_Files/Lista_Registros.c
	${MKDIR} -p ${OBJECTDIR}/C_Files
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_Files/Lista_Registros.o C_Files/Lista_Registros.c

${OBJECTDIR}/C_Files/Nodo.o: C_Files/Nodo.c
	${MKDIR} -p ${OBJECTDIR}/C_Files
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_Files/Nodo.o C_Files/Nodo.c

${OBJECTDIR}/C_Files/Registro.o: C_Files/Registro.c
	${MKDIR} -p ${OBJECTDIR}/C_Files
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_Files/Registro.o C_Files/Registro.c

${OBJECTDIR}/C_Files/Table.o: C_Files/Table.c
	${MKDIR} -p ${OBJECTDIR}/C_Files
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_Files/Table.o C_Files/Table.c
